...
function Home() {
  ...
  return (
    <div  className="font-caveat min-h-screen">
      <div id="home" className="relative min-h-screen text-white bg-gradient-to-b from-bgSky1 to-bgSky2 overflow-hidden bg-fixed">
        ...
        <img
          src={forest}
          className="absolute w-full left-0 bottom-40 z-40 scale-150 sm:scale-110"
        />
        ...
        <div className="absolute z-50 bg-black h-40 w-full bottom-0"></div>
      </div>
    </div>
  );
}
