...
function Home() {
  ...
  return (
    <div className="home font-caveat">
      <div className="relative min-h-screen text-white bg-gradient-to-b from-bgSky1 to-bgSky2 overflow-hidden bg-fixed">
        ...
        <img
          src={forest}
          className="absolute w-full h sm:h-auto left-0 bottom-0 z-50 scale-150 sm:scale-110"
        />
        <p className="text-5xl absolute sm:text-7xl top-[250px] sm:top-40 left-[25px] sm:left-20">
          Hello,
          <br />
          <span>I'm Yahya Aljundi</span>
        </p>
        <p className="absolute text-4xl top-[350px] sm:top-80 left-[25px] sm:left-20">
